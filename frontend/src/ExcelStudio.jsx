        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          ...
          <div>
            ...
            <p style={{ fontSize: '12px', color: 'var(--text-muted)' }}>
              Create multi-sheet workbooks from institutional records or upload full sheets (100+ entries) directly into your database.
            </p>
          </div>
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          ...
          <label className="upload-dropzone">
            ...
            <p style={{ fontSize: '13px', color: 'var(--text-muted)' }}>
              Supports multi-sheet workbooks with 100+ entries. You choose which sheet to import into database.
            </p>
          </label>
          ...
          {importLoading && (
            <div style={{ background: '#1e293b', borderRadius: '8px', padding: '12px 16px', border: '1px solid var(--border-color)' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '12px', marginBottom: '6px' }}>
                <span>Syncing records with Database Storage...</span>
          ...
          {importResult && (
            <div style={{
              ...
              <div style={{ flex: 1 }}>
                ...
                <p style={{ fontSize: '12px', color: 'var(--text-muted)' }}>
                  Total processed from sheet: <strong>{importResult.total}</strong> records. All valid rows are now live in the database!
                </p>
