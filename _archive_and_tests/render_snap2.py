...
draw.text((WIDTH // 2, 55), 'EduCore OS - Milestone 2 Architecture & Feature Snapshot (SNAP2)', fill='#FFFFFF', font=font_title, anchor='mm')
draw.text((WIDTH // 2, 88), 'Unified Admin-Style Portals | Universal SSO Login | Rich Dynamic Animation Suite | Class Teacher Routing', fill='#94A3B8', font=font_sub, anchor='mm')
...
kpis = [
    ...
    ('SYSTEM BACKUP STATE', 'SNAP2 VERIFIED & ARCHIVED', '#34D399')
]
...
s3_y = row2_y + 20
draw.text((30, s3_y), '3. Backup Manifest & Milestone Verification (SNAP2)', fill='#10B981', font=font_h2)
...
backup_data = [
    ...
    ('Archive Snapshot', 'backup_snap2 / snap2.zip', 'Archived', 'Full standalone code snapshot with all source code, models, and assets.')
]
...
draw.text((WIDTH - 40, HEIGHT - 20), 'EduCore OS - Milestone 2 Architecture & Backup Snapshot | Greenwood International Academy', fill='#64748B', font=font_small, anchor='rm')

out_root = 'snap2.png'
out_checklist = 'checklist/snap2.png'
out_artifact = 'C:/Users/bhuvn/.gemini/antigravity-ide/brain/a44e506e-693a-40ce-8d02-a99ca51b35ba/snap2.png'
...
print('SNAP2 generated successfully!')
