      ...
      <div className="modal-content" onClick={e => e.stopPropagation()} style={{ maxWidth: '600px' }}>
        ...
        <form onSubmit={handleSubmit}>
          <div className="modal-body form-grid" style={{ padding: '20px', gap: '16px' }}>
            ...
            <div className="form-group full-width" style={{ background: 'rgba(56, 189, 248, 0.06)', padding: '12px 14px', borderRadius: '10px', border: '1px solid rgba(56, 189, 248, 0.25)' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '6px' }}>
                <label style={{ display: 'flex', alignItems: 'center', gap: '6px', color: '#38bdf8', fontWeight: 700, margin: 0 }}>
      ...
      <div className="modal-content" onClick={e => e.stopPropagation()} style={{ maxWidth: '600px' }}>
        ...
        <form onSubmit={handleSubmit}>
          <div className="modal-body form-grid" style={{ padding: '20px', gap: '16px' }}>
            ...
            {/* Standard Tuition Fee for this Grade/Section */}
            <div className="form-group full-width" style={{ background: 'rgba(16, 185, 129, 0.06)', padding: '12px 14px', borderRadius: '10px', border: '1px solid rgba(16, 185, 129, 0.25)' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '6px' }}>
                <label style={{ display: 'flex', alignItems: 'center', gap: '6px', color: '#34d399', fontWeight: 700, margin: 0 }}>
                  <DollarSign size={15} /> Standard Academic Annual Tuition Fee (INR) *
                </label>
