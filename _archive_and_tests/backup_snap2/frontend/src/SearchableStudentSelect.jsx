    ...
    <div className="searchable-select-container" ref={containerRef}>
      ...
      {isOpen && (
        <div className="searchable-select-dropdown">
          <div style={{ padding: '7px 12px', fontSize: '11px', color: 'var(--text-dim)', background: '#1e293b', borderBottom: '1px solid var(--border-color)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              ...
              return (
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                    ...
                    <div>
                      <div style={{ color: 'white', fontSize: '13px', fontWeight: isSelected ? '700' : '500' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            <div>
              ...
              <div style={{ fontSize: '11px', color: 'var(--text-muted)' }}>
                Roll: <strong style={{ color: '#38bdf8' }}>{selectedStudent.roll_number}</strong>
